...
from tracker.ReMOT import ReMOT
...
def make_parser():
    parser = argparse.ArgumentParser("ReMOT Tracks For Evaluation!")
    ...
    parser.add_argument("--salient-dist", dest="salient_dist", default=False, action="store_true", help="use salient cosine dist")
...
def image_track(predictor, vis_folder, args):
    ...
    # Tracker
    tracker = ReMOT(args, frame_rate=args.fps)
    ...
    for ext in seqs_ext:
        for i in seqs:
            ...
            if args.default_parameters:
                ...
                elif seq == 'MOT17-01-FRCNN':
                    args.track_high_thresh = 0.65
                elif seq == 'MOT17-01-SDP':
                    args.track_high_thresh = 0.65

                elif seq == 'MOT17-03-DPM':
                    args.track_high_thresh = 0.65
                elif seq == 'MOT17-03-FRCNN':
                    args.track_high_thresh = 0.65
                elif seq == 'MOT17-03-SDP':
                    args.track_high_thresh = 0.65

                elif seq == 'MOT17-06-DPM':
                    args.track_high_thresh = 0.65
                elif seq == 'MOT17-06-FRCNN':
                    args.track_high_thresh = 0.65
                elif seq == 'MOT17-06-SDP':
                    args.track_high_thresh = 0.65
                
                elif seq == 'MOT17-07-DPM':
                    args.track_high_thresh = 0.55
                elif seq == 'MOT17-07-FRCNN':
                    args.track_high_thresh = 0.55
                elif seq == 'MOT17-07-SDP':
                    args.track_high_thresh = 0.55

                elif seq == 'MOT17-08-DPM':
                    args.track_high_thresh = 0.6
                elif seq == 'MOT17-08-FRCNN':
                    args.track_high_thresh = 0.6
                elif seq == 'MOT17-08-SDP':
                    args.track_high_thresh = 0.65

                elif seq == 'MOT17-12-DPM':
                    args.track_high_thresh = 0.65
                elif seq == 'MOT17-12-FRCNN':
                    args.track_high_thresh = 0.65
                elif seq == 'MOT17-12-SDP':
                    args.track_high_thresh = 0.65

                elif seq == 'MOT17-14-DPM':
                    args.track_high_thresh = 0.45
                elif seq == 'MOT17-14-FRCNN':
                    args.track_high_thresh = 0.45
                elif seq == 'MOT17-14-SDP':
                    args.track_high_thresh = 0.5                  

                elif seq in ['MOT20-06',  'MOT20-08']:
                    args.track_high_thresh = 0.3
                    exp.test_size = (736, 1920)
                elif seq in ['MOT20-07']:
                    args.track_high_thresh = 0.6
            ...
            print('track_high_thresh ', args.track_high_thresh)
            main(exp, args)
